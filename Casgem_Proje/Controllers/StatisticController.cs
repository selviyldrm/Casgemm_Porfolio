...
namespace Casgem_Proje.Controllers
{
    public class StatisticController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //En Yüksek Maşlı kişinin Adı Soyadı
            ...
            ViewBag.countSoftwareDepartment =
             db.TblEmployee.Where(x => x.EmployeeDepartment == db.TblDepartment.Where(z => z.DepartmentName == "Yazılım").
            ...
            ViewBag.sumSalaryFromDepertment = db.TblEmployee.Where(x => x.EmployeeCity == "Ankara" && x.EmployeeDepartment == db.TblDepartment.Where(z => z.DepartmentName == "Yazılım").Select(y => y.DepartmentID).FirstOrDefault()).Sum(w => w.EmployeeSalary);
            return View();
        }
    }
}